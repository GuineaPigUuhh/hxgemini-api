...
enum abstract HarmCategory(String)
{
	...
	public var HARM_CATEGORY_TOXICITY = 'HARM_CATEGORY_TOXICITY';
	public var HARM_CATEGORY_VIOLENCE = 'HARM_CATEGORY_VIOLENCE';
	...
	public var HARM_CATEGORY_CIVIC_INTEGRITY = 'HARM_CATEGORY_CIVIC_INTEGRITY';
}
